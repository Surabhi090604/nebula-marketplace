...
let mockProducts = {} // Changed to object to match Firebase structure
let mockOrders = {} // Changed to object to match Firebase structure
let mockChatHistory = []
  ...
  ref: (path) => {
    return {
      ...
      push: async (data) => {
        ...
        // Use the key from the data if it exists, otherwise use generated key
        const productId = data.id || key
        mockProducts[key] = { ...data, id: productId }
        saveToStorage()
